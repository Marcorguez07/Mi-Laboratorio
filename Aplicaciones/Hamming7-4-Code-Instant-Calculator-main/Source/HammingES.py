...
def askagain():
    ...
    while command == (""):
        try:
            command = input("Que modo desea usar: Hamming_Comprobación o Hamming_Conversión: ")
        except:
            pass
    if command == ("Hamming_Comprobación") or command == ("Hamming_Comprobacion"):
        command = ("")
        while command == (""):
            try:
                command = input("Que paridad usa este código de Hamming? (Par o Impar?): ")
            except:
                pass
        if command == ("Par"):
            checkinghammingpar()
            ...
            print(f"{command} no es un tipo de paridad (Par o Impar), intentelo de nuevo...")
            askagain()   
    elif command == ("Hamming_Conversión") or command == ("Hamming_Conversion"):
        command = ("")
        while command == (""):
            try:
                command = input("Que paridad usa este código de Hamming? (Par o Impar?): ")
...
def checkinghammingimpar():
    ...
    upcheckinstr = ("")
    totalcheckinstr = ("")
    insertedvar = input("Introduce un valor de siete digitos en formato Hamming7-4: ")
    ...
    if totalcheckinstr == binary0:
        print("No hay errores en este código Hamming7-4!")
        askagain()
    else:
        var1 = str(int1)
        var2 = str(int2)
        ...
        var6 = str(int6)
        var7 = str(int7)
        newhamming = (f"Hamming(7,4) corregido: {var7}{var6}{var5}{var4}{var3}{var2}{var1}\n\n")
        infobits = (f"Digitos de información: {var7}{var6}{var5}{var3}\n\n")
        print(f"{newhamming}\n{infobits}")
        del int1, int2, int3, int4, int5, int6, int7
